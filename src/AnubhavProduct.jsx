...
export default function AnubhavProduct({ onNavigate, isDarkTheme, onBookDemo, onToggleTheme }) {
    ...
    // Color Options State
    const colorOptions = [
        { name: 'Purple', image: 'purple.webp', color: '#9C27B0' },
        { name: 'Sky Blue', image: 'sky.webp', color: '#03A9F4' },
        { name: 'White', image: 'white2.webp', color: '#F5F5F5' },
        { name: 'Yellow', image: 'yellow.webp', color: '#FFEB3B' },
        { name: 'Brown', image: 'brown.webp', color: '#795548' },
        { name: 'Green', image: 'green.webp', color: '#4CAF50' },
        { name: 'Pink', image: 'pink.webp', color: '#E91E63' },
    ];
                ...
                <main style={{
                    ...
                    <section style={{ maxWidth: '550px' }}>
                        ...
                        <h1 style={{
                            ...
                            India's <span style={{ color: '#FF9B50' }}>First</span> Interactive <span style={{ color: '#FF9B50' }}>5D / 7D</span> Lab
                        </h1>
