...
import initialContent from '../data/vrElearningContent.json';
...
export default function VRElearning({ onNavigate, isDarkTheme, onBookDemo, onToggleTheme }) {
    ...
    useEffect(() => {
        ...
        fetch('/api/vr-elearning-live')
            ...
            .catch(err => console.error('[VRElearning] Error fetching live data:', err))
        ...
        <>
            ...
            <div className={`vr-product-container ${themeClass}`}>
                ...
                <section className="vr-product-section">
                    <h2 className="vr-product-section-title">{content.learningExperience.title}</h2>
                    <p className="vr-product-section-subtitle">{content.learningExperience.subtitle}</p>
                    <div className="vr-product-feature-grid">
                        {content.learningExperience.features.map((feature, idx) => (
