...
import initialContent from '../data/vrUdyogContent.json';
...
export default function VRUdyog({ onNavigate, isDarkTheme, onBookDemo, onToggleTheme }) {
    ...
    useEffect(() => {
        ...
        fetch('/api/vr-udyog-live')
            ...
            .catch(err => console.error('[VRUdyog] Error fetching live data:', err))
        ...
        <>
            ...
            <div className={`vr-product-container ${themeClass}`}>
                ...
                <section className="vr-product-section">
                    <h2 className="vr-product-section-title">{content.industrialToolkit.title}</h2>
                    <p className="vr-product-section-subtitle">{content.industrialToolkit.subtitle}</p>
                    <div className="vr-product-feature-grid">
                        {content.industrialToolkit.features.map((feature, idx) => (
