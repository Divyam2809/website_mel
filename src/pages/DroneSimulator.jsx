...
import initialContent from '../data/droneSimulatorContent.json';
...
export default function DroneSimulator({ onNavigate, isDarkTheme, onBookDemo, onToggleTheme }) {
    ...
    useEffect(() => {
        ...
        fetch('/api/drone-simulator-live')
            .then(res => res.json())
            .then(data => {
            ...
            .catch(err => console.error('[DroneSimulator] Error fetching live data:', err))
        ...
        <>
            ...
            <div className={`vr-product-container ${themeClass}`}>
                ...
                <section className="vr-product-section">
                    <h2 className="vr-product-section-title">{content.deck.title}</h2>
                    <p className="vr-product-section-subtitle">{content.deck.subtitle}</p>
                    <div className="vr-product-feature-grid">
                        {content.deck.features.map((feature, idx) => (
                ...
                <section className="vr-product-section alt-bg">
                    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
                        <h2 className="vr-product-section-title">{content.levels.title}</h2>
                        <p className="vr-product-section-subtitle">{content.levels.subtitle}</p>
                        <div className="vr-product-feature-grid">
                            {content.levels.tiers.map((tier, idx) => (
                                <div key={idx} className="vr-product-feature-card">
